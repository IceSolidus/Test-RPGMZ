 ...
 * rename the js file.
 * --------------------------Latest Version------------------------------------
 * Hi all, this latest version adds bold and italic as options for the game
 * info text. This version also makes the text the main font by default, in
 * case you do not specify your own font name.
 *
 * Version 1.3.2
 * - Added option to make font bold or italic or both
 * - Font should now be default game font if not provided in parameter
 *
 * @param Text Options
 *
 * @param Font Size
 ...
 * @type boolean
 * @default false
 * @desc If the font is bolded
 *
 * @param Font Italic
 * @parent Text Options
 * @type boolean
 * @default false
 * @desc If the font is italic
 *
...
CGMZ.GameInfo.FontBold = (CGMZ.GameInfo.parameters["Font Bold"] === 'true');
CGMZ.GameInfo.FontItalic = (CGMZ.GameInfo.parameters["Font Italic"] === 'true');
...
Scene_Title.prototype.CGMZ_GameInfo_DrawGameInfo = function () {
	...
	bitmap.fontFace = CGMZ.GameInfo.FontFace || $gameSystem.mainFontFace();
	bitmap.fontBold = CGMZ.GameInfo.FontBold;
	bitmap.fontItalic = CGMZ.GameInfo.FontItalic;
