 ...
 * VERSION HISTORY 
 * =============================================================================
 * v1.1 - Correção de não ativar o battleback automaticamente depois da primeira
 *        batalha.
...
// *  Initialize
//==============================
var _mog_bbex_spriteset_battle_initialize = Spriteset_Battle.prototype.initialize
Spriteset_Battle.prototype.initialize = function() {
	 _mog_bbex_spriteset_battle_initialize.call(this);
};
...
Spriteset_Battle.prototype.createBattleback = function() {
	 ...
	 for (var i = 0; i < $gameSystem._bbex.length; i++) {
 		 $gameSystem._bbex[i].enabled = false;
     };	 
	 this._bbEx_Sprite = [];
...
Spriteset_Battle.prototype.refreshBBEX = function() {
	$gameSystem._bbexData.needRefresh = false;
	for (var i = 0; i < $gameSystem._bbex.length; i++) {
         if ($gameSystem._bbex[i] && !$gameSystem._bbex[i].enabled) {this.createBattleBackEX(i)};
    };
};
...
// * createBattleBack
//==============================
Spriteset_Battle.prototype.createBattleBackEX = function(index) {
	$gameSystem._bbex[index].enabled = true;
	this._bbEx_Sprite[index] = new BattleBackEX(index);
	this._bbEx_Sprite[index].z = index;	
    if ($gameSystem._bbex[index].z == 0) {		
	    this._bbEX_field_1.addChild(this._bbEx_Sprite[index]);
	} else {
		this._bbEX_field_2.addChild(this._bbEx_Sprite[index]);
	};
